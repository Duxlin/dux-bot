...
const clui = import("clui")
const util = import("util")
const fetch = import("node-fetch")
const yts = import("yt-search")
const Crypto = import("crypto")
const ff = import('fluent-ffmpeg')
const webp = import("node-webpmux")
const cheerio = import("cheerio")
const cfonts = import("cfonts")
const BodyForm = import("form-data")
const mimetype = import("mime-types")
const speed = import("performance-now")
...
const fs = import('fs')
const yargs = import('yargs/yargs')
...
try {
  ...
  low = import('./lib/lowdb')
}

const { Low, JSONFile } = low
const mongoDB = import('./lib/mongoDB')
